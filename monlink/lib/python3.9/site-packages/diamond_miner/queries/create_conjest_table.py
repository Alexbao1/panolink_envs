...
from diamond_miner.queries.query import Query, StoragePolicy, conjest_table
from diamond_miner.typing import IPNetwork


@dataclass(frozen=True)
class CreateConjestTable(Query):
    ...
    def statement(
        ...
        return f"""
        CREATE TABLE IF NOT EXISTS {conjest_table(measurement_id)}
        (
