...
def rtt_table(measurement_id: str) -> str:
    return f"rtt__{measurement_id}".replace("-", "_")

def far_end_table(measurement_id: str) -> str:
    return f"far_end__{measurement_id}".replace("-", "_")

def conjest_table(measurement_id: str) -> str:
    return f"conjest__{measurement_id}".replace("-", "_")

def link_congest_table(measurement_id: str) -> str:
    return f"link_conjest__{measurement_id}".replace("-", "_")

def link_rtt_inflation_table(measurement_id: str) -> str:
    return f"link_rtt_inflation__{measurement_id}".replace("-", "_")

def rtt_std_table(measurement_id: str) -> str:
    return f"rtt_std__{measurement_id}".replace("-", "_")

def fault_link_table(measurement_id: str) -> str:
    return f"fault_link__{measurement_id}".replace("-", "_")
