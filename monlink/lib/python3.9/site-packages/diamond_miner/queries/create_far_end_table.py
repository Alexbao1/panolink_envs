...
from diamond_miner.queries.query import Query, StoragePolicy, far_end_table
from diamond_miner.typing import IPNetwork


@dataclass(frozen=True)
class CreateFarEndTable(Query):
    ...
    def statement(
        ...
        return f"""
        CREATE TABLE IF NOT EXISTS {far_end_table(measurement_id)}
        (
            probe_dst_addr         IPv6,
        ...
        ENGINE MergeTree
        ORDER BY (probe_dst_addr, probe_src_port)
